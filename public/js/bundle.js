...
var DomainActions = function () {
    function DomainActions() {
        ...
        this.generateActions('getActionSuccess', 'getActionFail');
    }

    _createClass(DomainActions, [{
        key: 'getAction',
        value: function getAction(params) {
            var _this = this;
            ...
            $.ajax({
                ...
                _this.actions.getActionSuccess(data);
            }).fail(function (jqXhr) {
                _this.actions.getActionFail(jqXhr);
            });
        }
    }]);
...
},{"../../custom_modules/jsUtils":8,"../actions/Actions":1,"../stores/Store":7,"react":"react"}],4:[function(require,module,exports){
'use strict';
...
var HomeComponent = function (_React$Component) {
    ...
    _createClass(HomeComponent, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_Component2.default, { className: 'Component' });
        }
    }]);
...
},{"../../custom_modules/jsUtils":8,"../actions/Actions":1,"../stores/Store":7,"./Component":3,"react":"react"}],5:[function(require,module,exports){
'use strict';
...
exports.default = _react2.default.createElement(_reactRouter.Route, { path: '/', component: _HomeComponent2.default });

},{"./components/HomeComponent":4,"react":"react","react-router":"react-router"}],7:[function(require,module,exports){
'use strict';
...
var Store = function () {
    ...
    _createClass(Store, [{
        key: 'onActionSuccess',
        value: function onActionSuccess(data) {}
    }, {
        key: 'onActionFail',
        value: function onActionFail() {}
    }]);

    return Store;
}();

exports.default = _alt2.default.createStore(Store);

},{"../actions/Actions":1,"../alt":2}],8:[function(require,module,exports){
"use strict";
